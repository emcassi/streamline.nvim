...
describe("Streamline insert buffer behavior", function()
	...
	it("insert a second buffer into the list from index 1, behavior = beginning", function()
		...
		assert.is_true(core:get_buffer_order()[1] == buf2_id)
		assert.is_true(core:get_buffer_by_id(buf2_id).index == 1)
	end)
	...
	it("inserts a third buffer into the list from index 1, behavior = beginning", function()
		...
		assert.is_true(core:get_buffer_by_id(buf3_id) ~= nil)
		assert.is_true(vim.tbl_contains(core:get_buffer_order(), buf3_id))
		assert.is_true(core:get_buffer_by_id(buf3_id).index == 1)
	end)
	...
	it("insert a second buffer into the list from index 1, behavior = end", function()
		...
		assert.is_true(core:get_buffer_by_id(buf2_id) ~= nil)
		assert.is_true(core:get_buffer_order()[2] == buf2_id)
		assert.is_true(core:get_buffer_by_id(buf2_id).index == 2)
	end)
	...
	it("inserts a third buffer into the list from index 1, behavior = end", function()
		...
		assert.is_true(core:get_buffer_by_id(buf3_id) ~= nil)
		assert.is_true(core:get_buffer_order()[3] == buf3_id)
		assert.is_true(vim.tbl_contains(core:get_buffer_order(), buf3_id))
		assert.is_true(core:get_active_buf().index == 3)
	end)
	...
	it("inserts a third buffer into the list from index 1, behavior = before", function()
		...
		assert.is_true(core:get_buffer_by_id(buf3_id) ~= nil)
		assert.is_true(vim.tbl_contains(core:get_buffer_order(), buf3_id))
		assert.is_true(core:get_buffer_order()[1] == buf3_id)
		assert.is_true(core:get_active_buf().index == 1)
	end)
	...
	it("inserts a third buffer into the list from index 2, behavior = before", function()
		...
		assert.is_true(core:get_buffer_by_id(buf3_id) ~= nil)
		assert.is_true(vim.tbl_contains(core:get_buffer_order(), buf3_id))
		assert.is_true(core:get_buffer_order()[2] == buf3_id)
		assert.is_true(core:get_active_buf().index == 2)
	end)
